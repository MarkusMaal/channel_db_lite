...
return [
    ...
    'Kommentaarid (videod alamleht)' => 'Comments (videos subpage)',
    ...
    'Mul oli siis vähem kogemusi PHP rakenduste kirjutamise osas (olin siis alles algaja)' => 'I had less experience writing PHP applications (I was just a beginner)',
    'Suur osa koodist asus ühes failis ning seetõttu oli selle lugemine raskendatud, mis muutis uute versioonide loomise keerulisemaks' => 'A big chunk of the code was in a single file, which made reading it difficult, which then made creation of new versions more difficult',
    'Tahtsin õppida Yii2 raamistikku kasutama ning leidsin, et kanali andmebaasi värskendamine on üks hea vaba aja väljakutse' => 'I wanted to learn to use Yii2 framework and found that creating a new channel database was a nice challenge for myself',
